...
#define HEATEQUATION1D(gridname,location,xstep,conductivity,tstep) gridname[1][location] = gridname[0][location] + (LAPLACIAN1(gridname[0],location,xstep) * tstep * tstep * conductivity)

#define HEATEQUATION2D(gridname,locationx,locationy,xstep,conductivity,tstep) gridname[1][locationx][locationy] = gridname[0][locationx][locationy] + (LAPLACIAN2(gridname[0],locationx,locationy,xstep) * tstep * tstep * conductivity)
